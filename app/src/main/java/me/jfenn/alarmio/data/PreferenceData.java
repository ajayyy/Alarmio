...
public enum PreferenceData {
    ...
    REMOTE_DISMISS_ENABLED(false),
    REMOTE_DISMISS_AUTHCODE("CHANGE_THIS"),
    REMOTE_DISMISS_SERVER("https://remotealarm.ajay.app"),
    REMOTE_DISMISS_AUTO_DISMISS(false),
    REMOTE_DISMISS_MAX_SNOOZES(0),
    REMOTE_DISMISS_SNOOZES(0),
    SHOW_SNOOZE_OPTIONS(true),
